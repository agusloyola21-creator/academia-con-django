...
CourseDeleteView, CourseEnrollmentView,StudentListMarkView,UpdateMarkView,ErrorView,AttendanceListView, AddAttendanceView,
evolution, ProfilePasswordChangeView, AddUserView, CustomLoginView, UserDetailsView, superuser_edit)
...
urlpatterns = [
    ...
    # PAGINA DE PREGUNTAS Y RESPUESTAS / PAGINA DE ACERCA DE

    # PAGINAS DE LOGIN Y REGISTRO
    path('register/', RegisterView.as_view(), name='register'),

    # PAGINAS DE PERFIL: VISTA DE PERFIL - EDICION DEL PERFIL
    path('profile/', login_required(ProfileView.as_view()), name='profile'),
    # PAGINA QUE ADMINISTRA LOS CURSOS: LA LISTA DE CURSOS - (LA CREACION DE CURSOS - LA EDICION DE CURSOS - LA ELIMINACION DE CURSOS)
    ...
    # PAGINA DE VISTAS DE INSCRIPCION # INSCRIPCION DE UN ALUMNO A UN CURSO
    path('enroll_course/<int:course_id>',CourseEnrollmentView.as_view(), name = 'enroll_course' ),
    path('error/', login_required(ErrorView.as_view()), name='error_page'),

    # PAGINA ADMINISTRACION DE NOTAS: LISTA DE ESTUDIANTES POR CURSO - EDICION DE NOTAS
    path('course/<int:course_id>',StudentListMarkView.as_view(), name = 'student_list_mark' ),
    path('course/update_mark/<int:pk>',UpdateMarkView.as_view(), name = 'update_mark' ),
